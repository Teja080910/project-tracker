  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {pageItems.map((u, i) => (
            <div key={u.id} className={`flex items-center gap-3 px-4 py-3 rounded-lg border border-border hover:shadow-soft hover:border-foreground/20 transition-all duration-200 animate-fade-in-up stagger-${Math.min(i + 1, 7)} ${u.disabled ? 'opacity-50 bg-muted/30' : ''}`}>
